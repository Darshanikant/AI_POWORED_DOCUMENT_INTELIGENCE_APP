...
# Load environment variables (only for local use)
load_dotenv("new.env")

# Get API Key (Use st.secrets in Streamlit Cloud)
...
st.write("This is a WebApp where you can upload your PDF file and ask legal questions. The model will generate responses. Thank you!")
...
st.markdown("**⚠️ Disclaimer: The content is generated by AI. Please verify before use.**")
